      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 select-none">
        ...
        <div className="flex items-center gap-3 self-start sm:self-auto flex-wrap sm:flex-nowrap">
          <button
            ...
            className="bg-[#1e40af] hover:bg-[#1a368f] border border-transparent text-white font-semibold py-2 px-5 rounded-full text-xs transition flex items-center gap-2 cursor-pointer h-[40px] shadow-sm select-none shrink-0"
          >
